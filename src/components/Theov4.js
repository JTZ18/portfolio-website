  ...
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      <group position={[0.1, 0, 0]} rotation={[0.29, -0.69, 0.01]} scale={1.26}>
        <mesh castShadow receiveShadow geometry={nodes.vine_rod.geometry} material={nodes.vine_rod.material} />
      </group>
      <group position={[0, 0, -0.37]}>
        <group position={[0.06, -0.07, 0.43]} rotation={[-0.3, -0.04, 0.32]} scale={[1.22, 1.32, 1.22]}>
          ...
          <mesh
            ...
            material={nodes.theo_dad_hat_03.material}
          />
          <mesh
            castShadow
            receiveShadow
      ...
      <mesh
        ...
        material={nodes.Theo3_Theo_Legs11.material}
      />
    </group>
  )
}
